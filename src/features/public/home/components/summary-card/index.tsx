...
const SummaryCard = (props: { item: WitelData }) => {
  const { item } = props;
  return (
    <div className="bg-white w-full shadow-custom-4 p-4 flex flex-col gap-4 max-w-sm rounded-md">
      ...
      <button className="w-full h-9 text-white bg-neutral-950 hover:bg-neutral-700  text-sm cursor-pointer rounded">
        Lihat Selengkapnya
      </button>
    </div>
  );
