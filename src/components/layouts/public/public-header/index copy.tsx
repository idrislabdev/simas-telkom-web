...
const PublicHeader = () => {
  ...
  return (
    <header
      className={`w-full fixed top-0 left-0 right-0 max-w-[1536px] mx-auto z-50 px-10 py-5 transition-all duration-300 ${
        scrolled ? "backdrop-blur-md bg-white/70 shadow-md" : "bg-transparent"
      }`}
    >
      <div className="h-[50px] flex w-full justify-between items-center">
        {/* Logo */}
        ...
        {/* Menu */}
        <div className="bg-white shadow-custom-4 rounded-3xl h-full flex items-center gap-[22px] justify-center px-5">
